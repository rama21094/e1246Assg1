...
# start = time.time()
#
# pickle_out = open("gutenbergUnigrams.pickle", "wb")
# pickle.dump(Unigrams, pickle_out)
# pickle_out.close()
#
# pickle_out = open("gutenbergBigrams.pickle", "wb")
# pickle.dump(Bigrams, pickle_out)
# pickle_out.close()
#
# pickle_out = open("gutenbergTrigrams.pickle", "wb")
...
pickle_in = open("gutenbergUnigrams.pickle", "rb")
Unigrams = pickle.load(pickle_in)

pickle_in = open("gutenbergBigrams.pickle", "rb")
Bigrams = pickle.load(pickle_in)

pickle_in = open("gutenbergTrigrams.pickle", "rb")
